...
Your pal reacts automatically as you chat, but you can also ask it to do something. It comes with 30 pre-listed actions, including `happy`, `thinking`, `celebrating`, and `waving`. Try `/pi-pal waving` to say hello.
